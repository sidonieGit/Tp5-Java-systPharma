...
public class GestionUtilisateur {
    ...
    public Client creerCompteClient(String nom, String prenom, String email, String adresse, String tel, String mdp) {
        Client client = new Client(nom, prenom, email, tel,adresse, mdp, 0);
    ...
    public AgentPharmacie creerCompteAgent(Administrateur admin, String nom, String prenom, String email, String adresse, String tel, String mdp, String matricule) {
        AgentPharmacie agent = new AgentPharmacie(nom, prenom, email, adresse, tel, mdp, matricule);
